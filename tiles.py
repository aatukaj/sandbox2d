...
class Tile:
    def __init__(self, img_path, transparent = False, rect=pg.FRect(0, 0, TILE_SIZE, TILE_SIZE), break_time = 1, break_level = 0):
...
DIRT = Tile("textures/1.png")
GRASS = Tile("textures/2.png")
STONE = Tile("textures/3.png")
GRASS_PLANT = Tile("textures/4.png", transparent=True, rect=None)
